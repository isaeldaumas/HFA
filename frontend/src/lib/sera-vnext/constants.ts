...
export const SERA_VNEXT_HUMAN_REVIEW_PROHIBITED_OUTPUTS = [
  'CLASSIFIED',
  'finalConclusion',
  'HFACS',
  'Risk/ERC',
...
export const SERA_VNEXT_STATUS = {
  ...
  PARTIAL_HUMAN_REVIEW_GATE_READY_NOT_CLASSIFIED: 'PARTIAL_HUMAN_REVIEW_GATE_READY_NOT_CLASSIFIED',
  PARTIAL_HUMAN_DECISION_INPUT_VALIDATED_NOT_CLASSIFIED: 'PARTIAL_HUMAN_DECISION_INPUT_VALIDATED_NOT_CLASSIFIED',
  PARTIAL_MANUAL_CLASSIFICATION_DRY_RUN_NOT_RELEASED: 'PARTIAL_MANUAL_CLASSIFICATION_DRY_RUN_NOT_RELEASED',
